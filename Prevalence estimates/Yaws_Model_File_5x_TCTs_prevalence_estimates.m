...
for j = 1:length(coverage) % iterate over the different coverage levels defined by the 'coverage variable
    for l = 1:length(time)
        for i = 1:loops
            ...
            X = [X1(1:end,:); X2(2:end,:); X3(2:end,:); X4(2:end,:); X5(2:end,:); X6(2:end,:); X7(2:end,:); X8(2:end,:); X9(2:end,:); X10(2:end,:); X11(2:end,:);];
...
%% Saving output
save('x5_TCT_prev_reduc_mean.mat', 'proportion_reduction_pe')
save('x5_TCT_prev_reduc_MAX.mat', 'proportion_reduction_MAX')
save('x5_TCT_prev_reduc_MIN.mat', 'proportion_reduction_MIN')
...
save results5x_TCTs_empirical_compare.mat
