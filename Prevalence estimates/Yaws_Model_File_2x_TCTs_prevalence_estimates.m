%% FILES NOTES
% Empirical Compare - recording the reduction in prevalence.
% not the end time here is 6 months after
...
%% Saving output
save('x2_TCT_prev_reduc_mean.mat', 'proportion_reduction_pe')
save('x2_TCT_prev_reduc_MAX.mat', 'proportion_reduction_MAX')
save('x2_TCT_prev_reduc_MIN.mat', 'proportion_reduction_MIN')
...
save results2x_TCTs_empircal_compare.mat
toc